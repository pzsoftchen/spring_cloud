...
@Slf4j
@Data
public abstract class UserSyncListener implements SmartApplicationListener
{
    /**
    ...
    public void onApplicationEvent(ApplicationEvent applicationEvent) {
        ...
        System.out.println("用户："+user.getAccount()+"，注册成功，发送notify通知。clientId:"+clientId+"。url:"+this.getNofityUrl());
    }
    ...
    public abstract String getNofityUrl();
}
